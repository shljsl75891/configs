 ...
 *
 * Source: verbatim copy of @earendil-works/pi-coding-agent's official
 * examples/extensions/question.ts, kept as tool name "question" to match
 * opencode's `question` tool convention used in ported subagent definitions.
 */
